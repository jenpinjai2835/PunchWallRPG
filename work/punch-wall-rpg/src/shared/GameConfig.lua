...
GameConfig.Pets = {
	...
	{ name = "Frost Hydra", rarity = "Legendary", baseWeight = 360, minDepth = 48, mult = 3.2, luckGain = 0.34, color = Color3.fromRGB(73, 137, 205), accent = Color3.fromRGB(144, 242, 255), visual = "Dragon", artKey = "FrostHydra", templateName = "Sanitized_ElectraHydraPet", packModel = "Electra Hydra", companionHeight = 2.3 },
	{ name = "Thunder Roc", rarity = "Legendary", baseWeight = 250, minDepth = 54, mult = 4.8, luckGain = 0.42, color = Color3.fromRGB(175, 114, 36), accent = Color3.fromRGB(255, 238, 82), visual = "Phoenix", artKey = "ThunderRoc", templateName = "Sanitized_EnragedPhoenixPet", packModel = "Enraged Phoenix", companionHeight = 2.28 },
	...
	{ name = "Solar Kirin", rarity = "Secret", baseWeight = 66, minDepth = 68, mult = 15, luckGain = 0.74, color = Color3.fromRGB(213, 147, 34), accent = Color3.fromRGB(255, 249, 143), visual = "Celestial", artKey = "SolarKirin", templateName = "Sanitized_MythicRadiantOnePet", packModel = "Mythic Radiant One", companionHeight = 2.5 },
