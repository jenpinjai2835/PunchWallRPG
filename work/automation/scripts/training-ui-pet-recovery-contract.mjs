...
const checks = [
  ...
  ["inventory_compact_cards_reserve_art_from_tags", inventory.includes('"HorizontalPreviewV5"') && inventory.includes("cardRef.artFrame.Position = UDim2.fromOffset(8 / scale, 8 / scale)") && inventory.includes("cardRef.rarity.Position = UDim2.fromOffset(92 / scale, 46 / scale)") && recoveryFlow.includes("ItemRarity") && recoveryFlow.includes("EquippedBadge") && recoveryFlow.includes("LockedBadge")],
