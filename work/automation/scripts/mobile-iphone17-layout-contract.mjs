...
const checks = [
  ...
  ["shop_uses_full_width_readable_mobile_rows", client.includes('"MobileReadableRowsV1"') && client.includes("local catalogColumns = compactCards and 1 or 2") && client.includes("local scrollCardHeight = compactCards and 112 or 154") && client.includes("productNameSize.MinTextSize = compactCards and 14 or 10") && client.includes("rarityLabel.TextSize = 12")],
