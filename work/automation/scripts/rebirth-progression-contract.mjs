...
const checks = [
  ...
  ["mobile_rebirth_target_is_at_least_44", client.includes("PhoneLandscape2x2TightV4") && client.includes("local compactMenuWidth = math.max(48") && client.includes('shared.PunchWallReferenceRebirth:SetAttribute("ToolAction", "OpenRebirthReview")') && client.includes('button:SetAttribute("MinimumTouchTarget", 44)') && client.includes("enforceReferenceTouchTarget(button)")],
