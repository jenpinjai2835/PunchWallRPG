...
const checks = [
  ...
  ["mobile_rebirth_target_is_at_least_44", client.includes("CompactTouchGrid58x72WithRebirth") && client.includes('shared.PunchWallReferenceRebirth:SetAttribute("ToolAction", "OpenRebirthReview")') && client.includes('button:SetAttribute("MinimumTouchTarget", 44)')],
