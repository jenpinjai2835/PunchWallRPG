...
$additionalStaticContracts = @(
    ...
    @{ file = "camera-published-cache-contract.mjs"; key = "cameraPublishedCacheContract" },
    @{ file = "world-reset-emote-readiness-contract.mjs"; key = "worldResetEmoteReadinessContract" },
